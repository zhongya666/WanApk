...
/**
 * GitHub/Gitee：zhongya666 2021/7/7 16:43
 *首页文章模块的数据源，主要配合Paging3进行数据请求与显示
 */

class ArticlePagingDataSource(private val service: HomeApi) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ArticleData> {
        return try {
            ...
            val data = service.articleList(pageNum)
